        ...
        <div>
          ...
          <div className="flex mt-8">
            <Link
              ...
              href={`https://wa.me/50671447395?text=${encodeURIComponent(`Hola, me interesa más información sobre la camiseta: **${product.title}**`)} %0A${process.env.NEXT_PUBLIC_URL}/product/${slug}`}
              target="_blank"
