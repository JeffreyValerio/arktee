    ...
    return (
        <section className='container'>
            ...
            <div className="grid justify-center items-center mb-4">
                <h1 className='text-xl text-center px-4 py-2 bg-accent rounded mb-4 font-bold'>No se encontraron resultados para tu búsqueda: <span className="underline">{params.query}</span></h1>
            </div>
