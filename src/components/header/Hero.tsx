    ...
    <section className="relative h-[calc(100vh-4rem)] md:h-[calc(100vh-2.25rem-5rem)] flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full h-full flex items-start justify-end overflow-hidden pointer-events-none opacity-30 dark:opacity-20">
        <svg 
          ...
          className="w-[280px] h-[320px] sm:w-[360px] sm:h-[400px] md:w-[440px] md:h-[480px] lg:w-[520px] lg:h-[560px] xl:w-[600px] xl:h-[640px] mt-16 sm:mt-6 md:mt-8 lg:mt-10 xl:mt-12 ml-24 sm:ml-32 md:ml-40 lg:ml-52 xl:ml-64 -mr-12 sm:-mr-16 md:-mr-20 lg:-mr-24 xl:-mr-28"
          viewBox="0 0 1174.00 1280.000000"
...
-415 191 -473 211 -488 172z"/>
      ...
      <div className="relative z-10 max-width w-full px-4 sm:px-6 lg:px-8 h-full flex items-center justify-center">
        <div className="max-w-4xl mx-auto text-center w-full">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 mb-3 sm:mb-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full border border-gray-200 dark:border-gray-700 shadow-sm">
          ...
          {/* Main Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light tracking-tight text-gray-900 dark:text-gray-100 mb-3 sm:mb-4 px-2">
            Camisetas que
            <br />
            <span className="font-bold bg-gradient-to-r from-gray-900 to-gray-600 dark:from-gray-100 dark:to-gray-400 bg-clip-text text-transparent">
              Definen tu Estilo
            </span>
          </h1>

          {/* Subheading */}
          <p className="text-sm sm:text-base md:text-lg text-gray-600 dark:text-gray-400 mb-4 sm:mb-6 max-w-2xl mx-auto font-light leading-relaxed px-4">
            Descubre nuestra colección de camisetas premium. Diseño minimalista, calidad excepcional y comodidad sin igual.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            <Link href="#products">
              <Button
                size="lg"
                className="group px-5 sm:px-6 md:px-8 py-4 sm:py-5 text-xs sm:text-sm md:text-base font-medium rounded-full bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-200 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                Explorar Colección
            ...
            <Link href="/gender/unisex">
              <Button
                variant="outline"
                size="lg"
                className="px-5 sm:px-6 md:px-8 py-4 sm:py-5 text-xs sm:text-sm md:text-base font-medium rounded-full border-2 border-gray-300 dark:border-gray-600 hover:border-gray-900 dark:hover:border-gray-400 transition-all duration-300"
              >
                Ver Catálogo
              </Button>
            </Link>
          ...
          <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700">
            <div className="grid grid-cols-3 gap-2 sm:gap-4 md:gap-6 lg:gap-8 max-w-2xl mx-auto px-4">
              <div>
                <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-0.5 sm:mb-1">
                  500+
                </div>
